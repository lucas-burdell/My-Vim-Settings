...
let g:colors_name="lucascolor"

if !exists("g:lucascolor#high_contrast#comments")
    let g:lucascolor#high_contrast#comments = 1 
endif
if !exists("g:lucascolor#focus_variant")
    let g:lucascolor#focus_variant = 0
endif
...
if g:lucascolor#high_contrast#comments == 1
   ...
   hi! Comment guibg=bg guifg=#127205 ctermbg=bg ctermfg=248
endif

" Folds:
if g:lucascolor#focus_variant == 1
    hi! FoldColumn guibg=bg guifg=#303030 ctermbg=236 ctermfg=238
     "hi! FoldColumn guibg=bg guifg=#127205 ctermbg=236 ctermfg=238
else
